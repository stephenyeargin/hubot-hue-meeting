...
module.exports = (robot) ->
  ...
  guest_bri = process.env.PHILIPS_HUE_MEETING_BRI or 254
  guest_hue = process.env.PHILIPS_HUE_MEETING_HUE or 47125
  guest_sat = process.env.PHILIPS_HUE_MEETING_SAT or 254
